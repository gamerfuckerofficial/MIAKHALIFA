...
class Config(object):
    ...
    # REQUIRED
    API_KEY = ""
    OWNER_ID = "817088672" # If you dont know, run @MissRose_bot and do /id in pm
    OWNER_USERNAME = "ranger_op"
    ...
    BAN_STICKER = 'CAACAgUAAxkBAAEFcOBfFWU8rDbLGQj8QUdlGsgDiehXywACYQADij_ePnuoFvn91Ec4GgQ'  # banhammer marie sticker
