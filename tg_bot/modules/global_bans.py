...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if int(user_id) in SUDO_USERS:
        message.reply_text("WTF!! Dont You Know i can't Gban Sudo Users :V")
        return
    ...
    try:
        bot.send_message(user_id, "You've been globally banned from all groups where I am admin. If this is a mistake, you can appeal for your bail",parse_mode=ParseMode.HTML)
    except:
